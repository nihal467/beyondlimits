...
Update the contact details in `index.html` (search for "contact"):
- Phone numbers
- WhatsApp links
- Email addresses
- Available hours
- Educator names and qualifications
...
- Phone numbers and email are public contact information
...
- **Mrs. Roopa E M** - BSc, MSc, BEd - 15+ Years Experience
- **Ms. Aswathy S Menon** - BTech, MTech - 4+ Years Experience

## 📞 Contact

- **Website**: [beyondlimits.study](https://beyondlimits.study)
- **Email**: info@beyondlimits.study
- **Phone**: +91 9846644745, +91 9188089722
